...
public class tComic implements org.apache.thrift.TBase<tComic, tComic._Fields>, java.io.Serializable, Cloneable, Comparable<tComic> {
  ...
  private static final org.apache.thrift.protocol.TField CHAPTER_LIST_FIELD_DESC = new org.apache.thrift.protocol.TField("chapterList", org.apache.thrift.protocol.TType.LIST, (short)7);
  private static final org.apache.thrift.protocol.TField CATEGORY_LIST_FIELD_DESC = new org.apache.thrift.protocol.TField("categoryList", org.apache.thrift.protocol.TType.LIST, (short)8);
  ...
  public java.util.List<tChapter> chapterList; // required
  public java.util.List<tCategory> categoryList; // required
  ...
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    ...
    CHAPTER_LIST((short)7, "chapterList"),
    CATEGORY_LIST((short)8, "categoryList");
  ...
  static {
    ...
    tmpMap.put(_Fields.STATUS, new org.apache.thrift.meta_data.FieldMetaData("status", org.apache.thrift.TFieldRequirementType.DEFAULT, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.STRING)));
    tmpMap.put(_Fields.CHAPTER_LIST, new org.apache.thrift.meta_data.FieldMetaData("chapterList", org.apache.thrift.TFieldRequirementType.DEFAULT, 
  ...
  public tComic(tComic other) {
    ...
    if (other.isSetChapterList()) {
      java.util.List<tChapter> __this__chapterList = new java.util.ArrayList<tChapter>(other.chapterList.size());
      for (tChapter other_element : other.chapterList) {
        __this__chapterList.add(new tChapter(other_element));
      }
      this.chapterList = __this__chapterList;
    }
    if (other.isSetCategoryList()) {
      java.util.List<tCategory> __this__categoryList = new java.util.ArrayList<tCategory>(other.categoryList.size());
      for (tCategory other_element : other.categoryList) {
        __this__categoryList.add(new tCategory(other_element));
      }
  ...
  public tComic setName(java.lang.String name) {
    this.name = name;
    return this;
  }
  ...
  public tComic setUrlname(java.lang.String urlname) {
    this.urlname = urlname;
    return this;
  }
  ...
  public tComic setSource(java.lang.String source) {
    this.source = source;
    return this;
  }
  ...
  public int getChapterListSize() {
    return (this.chapterList == null) ? 0 : this.chapterList.size();
  }

  public java.util.Iterator<tChapter> getChapterListIterator() {
    return (this.chapterList == null) ? null : this.chapterList.iterator();
  }

  public void addToChapterList(tChapter elem) {
    if (this.chapterList == null) {
      this.chapterList = new java.util.ArrayList<tChapter>();
    }
    this.chapterList.add(elem);
  }

  public java.util.List<tChapter> getChapterList() {
    return this.chapterList;
  }

  public tComic setChapterList(java.util.List<tChapter> chapterList) {
    this.chapterList = chapterList;
    return this;
  }

  public void unsetChapterList() {
    this.chapterList = null;
  }

  /** Returns true if field chapterList is set (has been assigned a value) and false otherwise */
  public boolean isSetChapterList() {
    return this.chapterList != null;
  }

  public void setChapterListIsSet(boolean value) {
    if (!value) {
      this.chapterList = null;
    }
  }
  ...
  public java.util.Iterator<tCategory> getCategoryListIterator() {
    return (this.categoryList == null) ? null : this.categoryList.iterator();
  }

  public void addToCategoryList(tCategory elem) {
    if (this.categoryList == null) {
      this.categoryList = new java.util.ArrayList<tCategory>();
    }
    this.categoryList.add(elem);
  }

  public java.util.List<tCategory> getCategoryList() {
    return this.categoryList;
  }

  public tComic setCategoryList(java.util.List<tCategory> categoryList) {
    this.categoryList = categoryList;
    return this;
  }
  ...
  public void setFieldValue(_Fields field, java.lang.Object value) {
    ...
    case CHAPTER_LIST:
      if (value == null) {
        ...
        setChapterList((java.util.List<tChapter>)value);
      }
      break;
    ...
    case CATEGORY_LIST:
      if (value == null) {
        ...
        setCategoryList((java.util.List<tCategory>)value);
      }
      break;
  ...
  public boolean equals(tComic that) {
    ...
    boolean this_present_chapterList = true && this.isSetChapterList();
    boolean that_present_chapterList = true && that.isSetChapterList();
    if (this_present_chapterList || that_present_chapterList) {
      if (!(this_present_chapterList && that_present_chapterList))
        return false;
      if (!this.chapterList.equals(that.chapterList))
        return false;
    }
  ...
  public int hashCode() {
    ...
    hashCode = hashCode * 8191 + ((isSetChapterList()) ? 131071 : 524287);
    if (isSetChapterList())
      hashCode = hashCode * 8191 + chapterList.hashCode();
  ...
  public int compareTo(tComic other) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetChapterList()).compareTo(other.isSetChapterList());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetChapterList()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.chapterList, other.chapterList);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  private static class tComicStandardScheme extends org.apache.thrift.scheme.StandardScheme<tComic> {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.chapterList = new java.util.ArrayList<tChapter>(_list0.size);
                tChapter _elem1;
                for (int _i2 = 0; _i2 < _list0.size; ++_i2)
                {
                  _elem1 = new tChapter();
                  _elem1.read(iprot);
                  struct.chapterList.add(_elem1);
                }
                iprot.readListEnd();
              }
              struct.setChapterListIsSet(true);
            } else { 
              org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
            }
            break;
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.categoryList = new java.util.ArrayList<tCategory>(_list3.size);
                tCategory _elem4;
                for (int _i5 = 0; _i5 < _list3.size; ++_i5)
                {
                  _elem4 = new tCategory();
                  _elem4.read(iprot);
                  struct.categoryList.add(_elem4);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, tComic struct) throws org.apache.thrift.TException {
      ...
      if (struct.chapterList != null) {
        oprot.writeFieldBegin(CHAPTER_LIST_FIELD_DESC);
        {
          oprot.writeListBegin(new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, struct.chapterList.size()));
          for (tChapter _iter6 : struct.chapterList)
          {
            _iter6.write(oprot);
          }
          oprot.writeListEnd();
      ...
      if (struct.categoryList != null) {
        oprot.writeFieldBegin(CATEGORY_LIST_FIELD_DESC);
        {
          ...
          for (tCategory _iter7 : struct.categoryList)
          {
            _iter7.write(oprot);
          }
          oprot.writeListEnd();
  ...
  private static class tComicTupleScheme extends org.apache.thrift.scheme.TupleScheme<tComic> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, tComic struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetChapterList()) {
        {
          oprot.writeI32(struct.chapterList.size());
          for (tChapter _iter8 : struct.chapterList)
          {
            _iter8.write(oprot);
          }
        }
      ...
      if (struct.isSetCategoryList()) {
        {
          ...
          for (tCategory _iter9 : struct.categoryList)
          {
            _iter9.write(oprot);
          }
        }
      ...
      if (incoming.get(6)) {
        {
          ...
          struct.chapterList = new java.util.ArrayList<tChapter>(_list10.size);
          tChapter _elem11;
          for (int _i12 = 0; _i12 < _list10.size; ++_i12)
          {
            _elem11 = new tChapter();
            _elem11.read(iprot);
            struct.chapterList.add(_elem11);
          }
        }
        struct.setChapterListIsSet(true);
      }
      if (incoming.get(7)) {
        {
          ...
          struct.categoryList = new java.util.ArrayList<tCategory>(_list13.size);
          tCategory _elem14;
          for (int _i15 = 0; _i15 < _list13.size; ++_i15)
          {
            _elem14 = new tCategory();
            _elem14.read(iprot);
            struct.categoryList.add(_elem14);
          }
        }
        struct.setCategoryListIsSet(true);
      }
